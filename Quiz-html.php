...
<div id='page-wrap'>
    ...
    $sql = "SELECT question_name,answer1,answer2,answer3,answer4,answer FROM questions WHERE category_id ='2'";
    $result = mysqli_query($db, $sql) or die(mysqli_error($db));


    echo "<h1 style=' font-size:30px;margin-top: 5%; ' ALIGN='center'>" . 'HTML' . "</h1>";
